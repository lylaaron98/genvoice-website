    ...
    return (
        <Container component="main" maxWidth="md" sx={{ mt: 8 }}>
            <Paper elevation={3} sx={{ p: 4 }}>
                ...
                <Typography variant="h6" gutterBottom>
                    <Button href="https://linkedin.com/in/aaron-lee-b832431b3" target="_blank" color="primary">
                        LinkedIn
                    </Button>{" "}
                    •{" "}
                ...
                <section>
                    ...
                    <Typography variant="body1">
                        <strong>Frameworks and Tools:</strong> NodeJS, ReactJS, ExpressJS, TailwindCSS, AntDesign, Django, Docker, Kubernetes, JUCE, Unity, TensorFlow, RESTAPI, Git, MicrosoftSQLServer, JIRA
                    </Typography>
                    <Typography variant="body1">
